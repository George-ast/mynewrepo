...
Print this new list
3 - in new list calculate total numbers
of "female"  and "male" and print it as small table
...
people_list.sort(key=itemgetter(1, 4))
print(people_list)
new_people = people_list[2:-2]
print(new_people)

"""
Total numbers of "female"  and "male.
"""

female_count = sum(person[4] == 'female' for person in people_list)
male_count = sum(person[4] == 'male' for person in people_list)
